...
from (
  ...
  select
    ...
    count(*) as cnt
  from @src_schema.procedure_occurrence
  ...
  select
    ...
    count(*) as cnt
  from @src_schema.condition_occurrence
  ...
  select
    ...
    count(*) as cnt
  from @src_schema.visit_occurrence
  ...
  select
    ...
    count(*) as cnt
  from @src_schema.device_exposure
